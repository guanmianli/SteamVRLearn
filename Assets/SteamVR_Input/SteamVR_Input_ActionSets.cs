...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_MyActionSet p_MyActionSet;
        ...
        public static SteamVR_Input_ActionSet_MyActionSet MyActionSet
        {
            get
            {
                return SteamVR_Actions.p_MyActionSet.GetCopy<SteamVR_Input_ActionSet_MyActionSet>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_MyActionSet = ((SteamVR_Input_ActionSet_MyActionSet)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_MyActionSet>("/actions/MyActionSet")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.MyActionSet};
        }
    }
}
